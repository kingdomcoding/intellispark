...
- **App:** https://intellispark.josboxoffice.com
- **Login:** `admin@sandboxhigh.edu` / `phase1-demo-pass` (shared demo account)
- **Status:** ![CI](https://github.com/kingdomcoding/intellispark/actions/workflows/ci.yml/badge.svg) · 554 tests · deployed from `main`
