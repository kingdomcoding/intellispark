defmodule IntellisparkWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IntellisparkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IntellisparkWeb.Gettext, "errors", msg, opts)
    end
  end
