defmodule IntellisparkWeb.Policies.DistrictAdminOfSchool do
  @moduledoc """
  Filter check: matches schools whose `district_id` equals the actor's `district_id`,
  ...
  def describe(_), do: "actor is a district-level admin of the school's district"
