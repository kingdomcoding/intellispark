defmodule IntellisparkWeb.Policies.StaffReadsFlagsForStudent do
  @moduledoc """
  FilterCheck on Flag reads. Scopes by the actor's school memberships and
  gates sensitive? == true behind clinical roles
  (admin / counselor / clinician / social_worker). Teachers see only
  non-sensitive flags in their school.
  """
  ...
  def describe(_), do: "staff reads flags in their school; clinical roles also see sensitive"
