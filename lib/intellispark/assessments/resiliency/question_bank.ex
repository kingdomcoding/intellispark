  ...
  @questions %{
    {:grades_9_12, "v1"} => [
      ...
      %{
        id: "9_12_c_2",
        skill: :confidence,
        prompt: "I feel capable when I face a new challenge."
      },
      %{
        id: "9_12_c_3",
        skill: :confidence,
        prompt: "I can speak up in class when I have something to share."
      },
      %{id: "9_12_p_1", skill: :persistence, prompt: "When something is hard, I keep trying."},
      %{
        id: "9_12_p_2",
        skill: :persistence,
        prompt: "I finish long assignments even when they feel boring."
      },
      %{id: "9_12_p_3", skill: :persistence, prompt: "I do not give up when I get stuck."},
      %{
        id: "9_12_o_1",
        skill: :organization,
        prompt: "I write down my homework and assignments."
      },
      ...
      %{
        id: "9_12_g_2",
        skill: :getting_along,
        prompt: "I listen to others' ideas, even when I disagree."
      },
      %{
        id: "9_12_g_3",
        skill: :getting_along,
        prompt: "I resolve disagreements without fighting."
      },
      %{
        id: "9_12_r_1",
        skill: :resilience,
        prompt: "I bounce back when things go wrong at school."
      },
      %{
        id: "9_12_r_2",
        skill: :resilience,
        prompt: "I can handle a bad grade without giving up."
      },
      %{
        id: "9_12_r_3",
        skill: :resilience,
        prompt: "I stay calm when plans change unexpectedly."
      },
      ...
      %{
        id: "9_12_u_3",
        skill: :curiosity,
        prompt: "I look for answers when I do not understand something."
      }
    ],
    {:grades_6_8, "v1"} => [
      ...
      %{
        id: "6_8_c_2",
        skill: :confidence,
        prompt: "I feel sure of myself when I try new things."
      },
      %{
        id: "6_8_c_3",
        skill: :confidence,
        prompt: "I raise my hand in class when I know the answer."
      },
      %{id: "6_8_p_1", skill: :persistence, prompt: "When schoolwork is hard, I keep going."},
      %{
        id: "6_8_p_2",
        skill: :persistence,
        prompt: "I finish what I start, even when it is not fun."
      },
      %{
        id: "6_8_p_3",
        skill: :persistence,
        prompt: "I keep trying when I do not get something right the first time."
      },
      %{id: "6_8_o_1", skill: :organization, prompt: "I keep track of my homework."},
      %{
        id: "6_8_o_2",
        skill: :organization,
        prompt: "I remember to bring the things I need to school."
      },
      ...
      %{
        id: "6_8_r_2",
        skill: :resilience,
        prompt: "I do not stay upset for long when something goes wrong."
      },
      %{
        id: "6_8_r_3",
        skill: :resilience,
        prompt: "I can keep working even after I make a mistake."
      },
